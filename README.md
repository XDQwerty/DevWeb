# 💻 Desenvolvimento Web - Projetos e Atividades

Este repositório contém os meus trabalhos práticos, exercícios de aula e projetos desenvolvidos na disciplina de **Desenvolvimento Web**.
...
1. Clone o repositório para a sua máquina:
   ```bash
   git clone [https://github.com/XDQwerty/DevWeb.git](https://github.com/XDQwerty/DevWeb.git)
